    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <ClipboardList className="h-4 w-4" style={{ color: '#178089' }} />
          <div className="text-xs font-medium" style={{ color: '#586D6A' }}>Assessments</div>
        </div>
        <Badge 
      ...
      <div className="rounded-lg p-3" style={{
        backgroundColor: assessmentsData.has_records ? '#B6D9CE' : '#F2EFED',
        border: assessmentsData.has_records ? '1px solid #56969D' : 'none'
      }}>
        <div className="flex items-center justify-between">
