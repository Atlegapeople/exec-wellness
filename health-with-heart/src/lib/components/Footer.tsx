...
export default function Footer() {
  ...
  return (
    <footer className="border-t w-full flex-shrink-0" style={{ backgroundColor: '#178089' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <a href="/employees" className="flex items-center gap-2 text-sm transition-colors" style={{ color: '#FFFFFF' }}>
                  <Users className="h-3 w-3" style={{ color: '#FFFFFF' }} />
                  Employee Management
                </a>
                <a href="/reports" className="flex items-center gap-2 text-sm transition-colors" style={{ color: '#FFFFFF' }}>
                  <FileText className="h-3 w-3" style={{ color: '#FFFFFF' }} />
                  Medical Reports
                </a>
                <a href="/appointments" className="flex items-center gap-2 text-sm transition-colors" style={{ color: '#FFFFFF' }}>
                  <Calendar className="h-3 w-3" style={{ color: '#FFFFFF' }} />
                  Appointments
                </a>
                <a href="/analytics" className="flex items-center gap-2 text-sm transition-colors" style={{ color: '#FFFFFF' }}>
        ...
        <div className="py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6 text-sm">
              <Button variant="ghost" size="sm" className="p-0" style={{ color: '#FFFFFF' }}>
                Privacy Policy
              </Button>
              <Button variant="ghost" size="sm" className="p-0" style={{ color: '#FFFFFF' }}>
                Terms of Service
