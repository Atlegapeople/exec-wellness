    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Ambulance className="h-4 w-4" style={{ color: '#D65241' }} />
          <div className="text-xs font-medium" style={{ color: '#586D6A' }}>Emergency Responses</div>
        </div>
        <Badge 
      ...
      <div className="rounded-lg p-3" style={{
        backgroundColor: emergencyData.has_records ? '#F5D8DC' : '#F2EFED',
        border: emergencyData.has_records ? '1px solid #EDBABE' : 'none'
      }}>
        <div className="flex items-center justify-between">
