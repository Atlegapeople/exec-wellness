...
export default function Employee360View({ employeeId, employee }: Employee360ViewProps) {
    ...
    return (
      <div className="w-full h-[700px] flex items-center justify-center">
        <Card className="max-w-md p-4 border-red-200 bg-red-50">
          <div className="flex items-center gap-2" style={{ color: '#D65241' }}>
    ...
    return (
      <div className="w-full h-[700px] flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          />
          <p style={{ color: '#759282' }}>No status data available for this employee</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="relative w-full h-[850px] overflow-hidden rounded-xl border" style={{ backgroundColor: '#F2EFED', borderColor: '#D7D9D9' }}>
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[160px] z-10">
        <div className="backdrop-blur-md border rounded-full px-4 py-2 shadow-lg" style={{ backgroundColor: 'rgba(242, 239, 237, 0.95)', borderColor: 'rgba(183, 214, 206, 0.4)', boxShadow: '0 10px 15px -3px rgba(183, 214, 206, 0.5)' }}>
          <div className="text-sm font-semibold text-center whitespace-nowrap" style={{ color: '#56969D' }}>
            {formatDateOfBirth(employee.date_of_birth?.toString() || '')}
          </div>
        </div>
      </div>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative">
          ...
          <div 
            ...
            style={{ 
              background: 'radial-gradient(circle, rgba(180, 202, 188, 0.25) 0%, rgba(180, 202, 188, 0.1) 40%, transparent 70%)'
            }}
          />
          <div 
            className="absolute inset-0 rounded-full blur-md scale-105"
            style={{ 
              background: 'radial-gradient(circle, rgba(117, 146, 130, 0.2) 0%, rgba(117, 146, 130, 0.05) 30%, transparent 60%)'
            }}
          />
          <Image
            src={getBodyImage()}
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 translate-y-[115px] z-10">
        <div className="backdrop-blur-md rounded-full px-4 py-2 shadow-lg" style={{ backgroundColor: 'rgba(242, 239, 237, 0.95)', boxShadow: '0 10px 15px -3px rgba(183, 214, 206, 0.5)' }}>
          <div className="text-sm font-semibold text-center whitespace-nowrap" style={{ color: '#56969D' }}>
