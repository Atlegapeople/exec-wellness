...
export default function Sidebar({ className }: SidebarProps) {
  ...
  if (!mounted) {
    return (
      <div className={cn('h-full w-64 bg-card border-r border-border flex flex-col', className)}>
              ...
              {!isCollapsed && (
                <div className="px-4 mb-2">
                  <h3 className={cn(
                    ...
                    section.title === 'Medical Management' && "text-[#E19985]", // Coral
                  ...
                  return (
                    ...
                    >
                      <div className={cn(
                        ...
                        colors.hoverBg,
                        colors.hoverText,
                        active && `${colors.activeBg} ${colors.activeText} font-medium border-l-4 ${colors.activeBorder}`,
                        isCollapsed && "justify-center px-2"
                      )}>
                        <Icon className={cn(
                          "h-5 w-5 flex-shrink-0 transition-colors",
                          active ? colors.activeText : `text-muted-foreground ${colors.iconHover}`
                        )} />
