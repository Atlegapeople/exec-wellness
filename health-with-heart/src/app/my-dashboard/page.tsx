...
export default function MyDashboard() {
  ...
  const doctors = useMemo(() => {
    return usersResponse?.users?.filter(user => user.type === 'Doctor') || [];
  }, [usersResponse]);
  const nurses = useMemo(() => {
    return usersResponse?.users?.filter(user => user.type === 'Nurse') || [];
  }, [usersResponse]);
                    ...
                    <div className='flex items-center justify-between'>
                      <div>
                        ...
                        <CardDescription className='mt-2 text-base text-gray-600'>
                          Complete list of all executive medical reports you
                          have created
                        </CardDescription>
                      </div>
                      <div className='flex items-center gap-2'>
                        ...
                        <div className='flex flex-col lg:flex-row lg:justify-between lg:items-start w-full gap-4'>
                          ...
                          <div className='flex items-center gap-2 flex-shrink-0'>
                            ...
                            <Button
                              ...
                              variant={
                                canGeneratePDF() ? 'default' : 'secondary'
                              }
                              size='sm'
                              className='hover-lift'
                              title={
                  ...
                  {dashboardData?.recentReports.map(report => (
                    <div key={report.id} className='p-4 rounded-lg border'>
                      <div className='flex items-start justify-between'>
                        ...
                        <Badge
                          variant={
                            report.doctor_signoff ? 'default' : 'secondary'
                          }
                        >
