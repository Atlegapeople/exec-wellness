  ...
  return (
    <DashboardLayout>
      <div className="pl-8 pr-[5vw] sm:pl-12 sm:pr-[6vw] lg:pl-16 lg:pr-[8vw] xl:pl-24 xl:pr-[10vw] py-6 max-w-full overflow-hidden">
        ...
        {(returnUrl || organizationFilter || siteFilter || costCenterFilter) && (
            ...
            <div className="flex items-center gap-4">
              {returnUrl && (
                ...
                >
                  ...
                  Back to {returnUrl.includes('organizations') ? 'Organizations' : returnUrl.includes('sites') ? 'Sites' : 'Cost Centers'}
                </Button>
              )}
