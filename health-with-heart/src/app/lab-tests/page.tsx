...
function LabTestsPageContent() {
  ...
  const [selectedLabTestId, setSelectedLabTestId] = useRouteState<
    string | null
  >('selectedLabTestId', null, { scope: 'path' });
            ...
            <Card>
              <CardContent>
                <PageLoading
                  ...
                  subtitle='Fetching laboratory test data from OHMS database...'
                />
              </CardContent>
            </Card>
          </div>
                ...
                <CardHeader>
                  <div className='flex items-center justify-between'>
                    ...
                    >
                      ...
                      {!selectedLabTest && (
                        <span className='ml-2'>Add New Lab Test</span>
                      )}
                    </Button>
                  </div>
                </CardHeader>
      ...
      fallback={
        <div className='min-h-screen bg-background flex items-center justify-center'>
          <Card>
            <CardContent>
              <PageLoading
                text='Initializing Lab Tests'
                subtitle='Setting up laboratory test management system...'
              />
            </CardContent>
          </Card>
        </div>
