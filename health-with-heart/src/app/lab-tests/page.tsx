...
export default function LabTestsPage() {
  ...
  const filterLabTests = useCallback((labTests: LabTest[], search: string) => {
    ...
    return labTests.filter(labTest => {
      const employeeName = `${labTest.employee_name || ''} ${labTest.employee_surname || ''}`.trim();
  ...
  const paginateLabTests = useCallback((labTests: LabTest[], page: number, limit: number) => {
  ...
  const transitionToPage = useCallback(async (newPage: number) => {
    ...
    const paginated = paginateLabTests(filteredLabTests, newPage, pagination.limit);
  ...
  useEffect(() => {
    ...
    setDisplayedLabTests(paginated);
  }, [allLabTests, searchTerm, filterLabTests, paginateLabTests, pagination.limit, searchParams]);
  ...
  }, [searchParams, pagination.page, filteredLabTests.length, transitionToPage]);
              ...
              <CardContent>
                {displayedLabTests.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-medium text-foreground mb-2">No lab tests found</h3>
                    <p className="text-muted-foreground">
                      {searchTerm ? 'Try adjusting your search criteria.' : 'No lab tests available.'}
                    </p>
                  </div>
                ) : (
                        ...
                        {displayedLabTests.map((labTest) => (
                          <TableRow 
                            ...
                            className={`cursor-pointer transition-colors hover:bg-muted/50 ${
                              selectedLabTest?.id === labTest.id ? 'bg-muted border-l-4 border-l-primary' : ''
                            }`}
                            ...
                            <TableCell>
                              <div>
                                ...
                                <div className="text-sm text-muted-foreground truncate">
                                  {labTest.employee_work_email || labTest.employee_id}
                                </div>
                              </div>
                            </TableCell>
                            <TableCell>
                              <Badge variant={getResultBadgeVariant(labTest.vitamin_d)}>
                                {labTest.vitamin_d || 'N/A'}
                              </Badge>
                            </TableCell>
                            <TableCell>
                              <Badge variant={getResultBadgeVariant(labTest.total_cholesterol)}>
                                {labTest.total_cholesterol || 'N/A'}
                              </Badge>
                            </TableCell>
                            <TableCell>
                              <Badge variant={
                                labTest.hiv === 'Negative' ? 'secondary' :
                                labTest.hiv === 'Positive' ? 'destructive' : 'outline'
                              }>
                                {labTest.hiv || 'N/A'}
                              </Badge>
                            </TableCell>
                            <TableCell className="text-sm">{formatDate(labTest.date_created)}</TableCell>
                  ...
                  <div className="flex justify-between items-start">
                    <div className="space-y-1">
                      ...
                      <CardDescription className="flex items-center gap-2">
                        <span className="text-lg font-medium">{getEmployeeName(selectedLabTest)}</span>
                ...
                <CardContent className="space-y-6 max-h-[600px] overflow-y-auto scrollbar-premium">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-3 text-sm">
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">Full Blood Count:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.full_blood_count_an_esr)}>
                          {selectedLabTest.full_blood_count_an_esr || 'N/A'}
                        </Badge>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">HIV Status:</span>
                        <Badge variant={
                          selectedLabTest.hiv === 'Negative' ? 'secondary' :
                          selectedLabTest.hiv === 'Positive' ? 'destructive' : 'outline'
                        }>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-3 text-sm">
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">Total Cholesterol:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.total_cholesterol)}>
                          {selectedLabTest.total_cholesterol || 'N/A'}
                        </Badge>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">HDL:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.hdl)}>
                          {selectedLabTest.hdl || 'N/A'}
                        </Badge>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">HS-CRP:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest['hs-crp'])}>
                          {selectedLabTest['hs-crp'] || 'N/A'}
                        </Badge>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">Homocysteine:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.homocysteine)}>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-3 text-sm">
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">Fasting Glucose:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.fasting_glucose)}>
                          {selectedLabTest.fasting_glucose || 'N/A'}
                        </Badge>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">HbA1c:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.hba1c)}>
                          {selectedLabTest.hba1c || 'N/A'}
                        </Badge>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">Insulin Level:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.insulin_level)}>
                          {selectedLabTest.insulin_level || 'N/A'}
                        </Badge>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">Uric Acid:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.uric_acid)}>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-3 text-sm">
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">Kidney Function:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.kidney_function)}>
                          {selectedLabTest.kidney_function || 'N/A'}
                        </Badge>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">Liver Enzymes:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.liver_enzymes)}>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-3 text-sm">
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">Vitamin D:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.vitamin_d)}>
                          {selectedLabTest.vitamin_d || 'N/A'}
                        </Badge>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">TSH:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.thyroid_stimulating_hormone)}>
                          {selectedLabTest.thyroid_stimulating_hormone || 'N/A'}
                        </Badge>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">PSA:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.psa)}>
                          {selectedLabTest.psa || 'N/A'}
                        </Badge>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">Hormones:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.hormones)}>
                          {selectedLabTest.hormones || 'N/A'}
                        </Badge>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[140px]">Adrenal Response:</span>
                        <Badge variant={getResultBadgeVariant(selectedLabTest.adrenal_response)}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData({...formData, vitamin_d: value})}
                >
                  <SelectTrigger>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Out of range but acceptable">Out of range but acceptable</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData({...formData, total_cholesterol: value})}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select result" />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                <Label htmlFor="full_blood_count_an_esr">Full Blood Count & ESR</Label>
                <Select
                  value={formData.full_blood_count_an_esr || ''}
                  onValueChange={(value) => setFormData({...formData, full_blood_count_an_esr: value})}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select result" />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData({...formData, kidney_function: value})}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select result" />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData({...formData, liver_enzymes: value})}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select result" />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData({...formData, fasting_glucose: value})}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select result" />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData({...formData, thyroid_stimulating_hormone: value})}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select result" />
                  </SelectTrigger>
        ...
        <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Update the lab test results for {editingLabTest ? getEmployeeName(editingLabTest) : ''}.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="total_cholesterol_edit">Total Cholesterol</Label>
                <Select
                  value={formData.total_cholesterol || ''}
                  onValueChange={(value) => setFormData({...formData, total_cholesterol: value})}
                >
              ...
              <div className="space-y-2">
                <Label htmlFor="full_blood_count_an_esr_edit">Full Blood Count & ESR</Label>
                <Select
                  value={formData.full_blood_count_an_esr || ''}
                  onValueChange={(value) => setFormData({...formData, full_blood_count_an_esr: value})}
                >
