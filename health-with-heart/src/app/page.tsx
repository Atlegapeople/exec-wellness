              ...
              <div className='text-center space-y-4'>
                ...
                <div className='flex flex-wrap justify-center gap-4 text-sm'>
                  <div className='flex items-center gap-2'>
                    <div
                      className={`w-2 h-2 rounded-full ${statsLoading ? 'bg-primary animate-pulse' : 'bg-green-500'}`}
                    ></div>
                  ...
                  <div className='flex items-center gap-2'>
                    <div
                      className={`w-2 h-2 rounded-full ${appointmentsLoading ? 'bg-primary animate-pulse' : 'bg-green-500'}`}
                    ></div>
                    <span className='text-muted-foreground'>Appointments</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <div
                      className={`w-2 h-2 rounded-full ${reportsLoading ? 'bg-primary animate-pulse' : 'bg-green-500'}`}
                    ></div>
                    <span className='text-muted-foreground'>
                      Medical Reports
                    </span>
          ...
          <Card className='glass-effect'>
            ...
            <CardContent>
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                <Button
                  variant='outline'
                  className='h-auto p-4 hover-lift justify-start'
                  asChild
                >
                  <a href='/employees'>
