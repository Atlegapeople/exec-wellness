              ...
              <div className="grid grid-cols-2 gap-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setFormData({...formData, manager_type: value})}
                  >
                    <SelectTrigger>
        ...
        <div className="managers-container flex gap-1 min-h-[600px]">
          ...
          >
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">Line Managers</CardTitle>
                  <UserCheck className="h-4 w-4 text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">
                    {managers.filter(m => m.manager_type === 'Line Manager').length}
                  </div>
                  <p className="text-xs text-muted-foreground">
                    Direct supervisors
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {managers.filter(m => m.manager_contact_number || m.manager_email).length}
                  </div>
                  <p className="text-xs text-muted-foreground">
              ...
              <CardContent>
                {managers.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-medium text-foreground mb-2">No managers found</h3>
                    <p className="text-muted-foreground">
                      {searchTerm ? 'Try adjusting your search criteria.' : 'No managers available.'}
                    </p>
                  </div>
                ) : (
                        ...
                        {managers.map((manager) => (
                          <TableRow 
                            ...
                            className={`cursor-pointer transition-colors hover:bg-muted/50 ${
                              selectedManager?.id === manager.id ? 'bg-muted border-l-4 border-l-primary' : ''
                            }`}
                  ...
                  <div className="flex justify-between items-start">
                    <div className="space-y-1">
                      ...
                      <CardDescription className="flex items-center gap-2">
                        <Badge variant="outline">{selectedManager.manager_type || 'Not specified'}</Badge>
                        {selectedManager.organisation_name && (
                          <Badge variant="secondary">{selectedManager.organisation_name}</Badge>
                        )}
                      </CardDescription>
                    </div>
                    <Button
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-3 text-sm">
                      <div className="flex gap-2">
                        ...
                        <span className="font-medium">{selectedManager.manager_name || 'N/A'}</span>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[120px]">Manager Type:</span>
                        <Badge variant="outline">{selectedManager.manager_type || 'N/A'}</Badge>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[120px]">Organization:</span>
                        <span className="font-medium">{selectedManager.organisation_name || 'N/A'}</span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-3 text-sm">
                      <div className="flex gap-2">
                        ...
                        <div className="flex-1">
                          ...
                          <span className="font-medium text-xs break-all">{selectedManager.manager_email || 'N/A'}</span>
                        </div>
                      </div>
                      <div className="flex gap-2">
                        ...
                        <div className="flex-1">
                          ...
                          <span className="font-medium">{selectedManager.manager_contact_number || 'N/A'}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-3 text-sm">
                      <div className="flex gap-2">
                        ...
                        <span className="font-medium">{formatDate(selectedManager.date_created)}</span>
                      </div>
                      {selectedManager.created_by_name && (
                        <div className="flex gap-2">
                          <span className="text-muted-foreground min-w-[120px]">Created By:</span>
                          <span className="font-medium">{selectedManager.created_by_name}</span>
                        </div>
                      )}
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[120px]">Last Updated:</span>
                        <span className="font-medium">{formatDate(selectedManager.date_updated)}</span>
                      </div>
                      {selectedManager.updated_by_name && (
                        <div className="flex gap-2">
                          <span className="text-muted-foreground min-w-[120px]">Updated By:</span>
                          <span className="font-medium">{selectedManager.updated_by_name}</span>
                        </div>
                      )}
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[120px]">Manager ID:</span>
                        <span className="font-mono text-xs">{selectedManager.id}</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="max-w-2xl">
            ...
            <div className="grid grid-cols-2 gap-4 py-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="edit_manager_contact_number">Contact Number</Label>
                <Input
