            ...
            <CardContent>
              {backups.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-foreground mb-2">No backup history</h3>
                  <p className="text-muted-foreground">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            <h4 className="font-medium capitalize">{backup.type} Backup</h4>
                            {getStatusBadge(backup.status)}
                          </div>
                          <p className="text-sm text-muted-foreground">
                            {formatDate(backup.date)} • {backup.size} • {backup.duration}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
          ...
          <Card className="mt-6 border-amber-200 bg-amber-50">
            <CardContent className="p-6">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold text-amber-800">Administrator Access Required</h3>
              </div>
              <p className="text-amber-700 text-sm">
                This page will be restricted to administrators only in future releases. 
                Data management operations require elevated privileges and will include 
                advanced features like automated backups, data validation, and audit trails.
              </p>
            </CardContent>
          </Card>
        </div>
