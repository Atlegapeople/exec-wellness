...
export default function SitesPage() {
  ...
  const handleViewEmployees = (site: Site) => {
    ...
    const orgName = encodeURIComponent(site.organisation_name || 'Organization');
  ...
  const handleViewReports = (site: Site) => {
    ...
    router.push(`/reports?site=${siteFilter}&siteName=${siteName}&returnUrl=${returnUrl}`);
  };
            ...
            <div className="flex items-center gap-4">
              {returnUrl && (
                ...
                >
                  ...
                  Back to {returnUrl === '/organizations' ? 'Organizations' : 'Previous Page'}
                </Button>
              )}
              ...
              <div className="grid grid-cols-1 gap-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData({...formData, site_admin_email: e.target.value})}
        ...
        <div className="sites-container flex gap-1 min-h-[600px]">
          ...
          >
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">With Admin Contact</CardTitle>
              ...
              <CardContent>
                {sites.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground">
                      {searchTerm ? 'Try adjusting your search criteria.' : 'No sites available.'}
                    </p>
                  </div>
                ) : (
                        ...
                        {sites.map((site) => (
                          <TableRow 
                            ...
                            className={`cursor-pointer transition-colors hover:bg-muted/50 ${
                              selectedSite?.id === site.id ? 'bg-muted border-l-4 border-l-primary' : ''
                            }`}
                          ...
                          >
                            ...
                            <TableCell>
                              <div className="flex items-center gap-2">
                                <span className="font-medium">{site.employee_count || 0}</span>
                                <span className="text-sm text-muted-foreground">employees</span>
                              </div>
                            </TableCell>
                            <TableCell>
                              <div className="flex items-center gap-2">
                                <span className="font-medium">{site.medical_report_count || 0}</span>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-3 text-sm">
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[120px]">Site Name:</span>
                        <span className="font-medium">{selectedSite.name || 'N/A'}</span>
                      </div>
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[120px]">Organization:</span>
                        <span className="font-medium">{selectedSite.organisation_name || 'N/A'}</span>
                      </div>
                      <div className="flex gap-2 items-start">
                        <span className="text-muted-foreground min-w-[120px]">Address:</span>
                        <span className="font-medium">{selectedSite.address || 'N/A'}</span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-3 text-sm">
                      <div className="flex gap-2">
                        ...
                        <div className="flex-1">
                          <div className="text-muted-foreground text-xs">Site Admin Email</div>
                          <span className="font-medium text-xs break-all">{selectedSite.site_admin_email || 'N/A'}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="font-semibold flex items-center gap-2 mb-2">
                          ...
                          {selectedSite.employee_count || 0} {(selectedSite.employee_count || 0) === 1 ? 'employee' : 'employees'}
                        </div>
                        <div className="text-xs text-muted-foreground mb-2">in organization</div>
                      ...
                      <div>
                        ...
                        <div className="font-semibold flex items-center gap-2 mb-2">
                          ...
                          {selectedSite.medical_report_count || 0} {(selectedSite.medical_report_count || 0) === 1 ? 'report' : 'reports'}
                        </div>
                        <div className="text-xs text-muted-foreground mb-2">at this site</div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-3 text-sm">
                      <div className="flex gap-2">
                        ...
                        <span className="font-medium">{formatDate(selectedSite.date_created)}</span>
                      </div>
                      {selectedSite.created_by_name && (
                        <div className="flex gap-2">
                          <span className="text-muted-foreground min-w-[120px]">Created By:</span>
                          <span className="font-medium">{selectedSite.created_by_name}</span>
                        </div>
                      )}
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[120px]">Last Updated:</span>
                        <span className="font-medium">{formatDate(selectedSite.date_updated)}</span>
                      </div>
                      {selectedSite.updated_by_name && (
                        <div className="flex gap-2">
                          <span className="text-muted-foreground min-w-[120px]">Updated By:</span>
                          <span className="font-medium">{selectedSite.updated_by_name}</span>
                        </div>
                      )}
                      <div className="flex gap-2">
                        <span className="text-muted-foreground min-w-[120px]">Site ID:</span>
                        <span className="font-mono text-xs">{selectedSite.id}</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
