...
function MedicalHistoryPageContent() {
  ...
  const [selectedMedicalHistoryId, setSelectedMedicalHistoryId] = useRouteState<
    string | null
  >('selectedMedicalHistoryId', null, { scope: 'path' });
    ...
    async (page = 1, search = '') => {
      try {
        ...
        if (
          ...
          console.log(
            'Pre-populating form with selected employee:',
            selectedMedicalHistory.employee_id
          );
  ...
  useEffect(() => {
    const restore = async () => {
      if (!selectedMedicalHistory && selectedMedicalHistoryId) {
        const found = medicalHistories.find(
          m => m.id === selectedMedicalHistoryId
        );
        if (found) {
        ...
        try {
          const res = await fetch(
            `/api/medical-history/${selectedMedicalHistoryId}`
          );
          if (res.ok) {
          ...
          <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className='text-xs text-muted-foreground'>Diabetes cases</p>
              </CardContent>
            </Card>
                            ...
                            >
                              ...
                              <TableCell>
                                <div className='flex flex-wrap gap-1'>
                                  ...
                                  {getConditionsBadges(medicalHistory)
                                    .length === 0 && (
                    ...
                    <div className='flex justify-between items-start'>
                      ...
                      <div className='flex items-center gap-2'>
                        <Button
                          ...
                          size='sm'
                          onClick={() =>
                            openDeleteModal(selectedMedicalHistory)
                          }
            ...
            <DialogContent className='max-w-4xl max-h-[80vh] overflow-y-auto'>
              ...
              <Tabs defaultValue='conditions' className='space-y-4'>
                ...
                <TabsContent value='allergies' className='space-y-4'>
                  <div className='space-y-4'>
                    ...
                    {formData.environmental && (
                      <div className='space-y-2 ml-6'>
                        <Label htmlFor='environmental_type'>
                          Environmental Type
                        </Label>
                        <Input
                ...
                <TabsContent value='family' className='space-y-4'>
                  <div className='space-y-4'>
                    <div className='space-y-2'>
                      <Label htmlFor='family_conditions'>
            ...
            <DialogContent className='max-w-4xl max-h-[80vh] overflow-y-auto'>
              ...
              <Tabs defaultValue='conditions' className='space-y-4'>
                  ...
                  <div className='grid grid-cols-2 gap-4'>
                    ...
                    <div className='flex items-center space-x-2'>
                      <input
                        ...
                        className='rounded border-gray-300'
                      />
                      <Label htmlFor='edit_high_cholesterol'>
                        High Cholesterol
                      </Label>
                    </div>
                    ...
                    <div className='flex items-center space-x-2'>
                      <input
                        ...
                        className='rounded border-gray-300'
                      />
                      <Label htmlFor='edit_thyroid_disease'>
                        Thyroid Disease
                      </Label>
                    </div>
                  ...
                  <div className='space-y-4'>
                    <div className='flex items-center space-x-2'>
                      <input
                        ...
                        className='rounded border-gray-300'
                      />
                      <Label htmlFor='edit_medication'>
                        Medication Allergies
                      </Label>
                    </div>
                    {formData.medication && (
                      <div className='space-y-2 ml-6'>
                        <Label htmlFor='edit_medication_type'>
                          Medication Type
                        </Label>
                        <Input
                          ...
                          placeholder='Specify medication allergy'
                        />
                        <Label htmlFor='edit_medication_severity'>
                          Severity
                        </Label>
                        <Select
                          value={formData.medication_severity || ''}
                    ...
                    <div className='flex items-center space-x-2'>
                      <input
                        ...
                        className='rounded border-gray-300'
                      />
                      <Label htmlFor='edit_environmental'>
                        Environmental Allergies
                      </Label>
                    </div>
                    {formData.environmental && (
                      <div className='space-y-2 ml-6'>
                        <Label htmlFor='edit_environmental_type'>
                          Environmental Type
                        </Label>
                        <Input
                          ...
                          placeholder='Specify environmental allergy'
                        />
                        <Label htmlFor='edit_enviromental_severity'>
                          Severity
                        </Label>
                        <Select
                          value={formData.enviromental_severity || ''}
                  ...
                  <div className='space-y-4'>
                    <div className='flex items-center space-x-2'>
                      <input
                        ...
                        className='rounded border-gray-300'
                      />
                      <Label htmlFor='edit_on_medication'>
                        Currently on Medication
                      </Label>
                    </div>
                    {formData.on_medication && (
                      <div className='space-y-2 ml-6'>
                        <Label htmlFor='edit_chronic_medication'>
                          Chronic Medication
                        </Label>
                        <Textarea
                ...
                <TabsContent value='family' className='space-y-4'>
                  <div className='space-y-4'>
                    <div className='space-y-2'>
                      <Label htmlFor='edit_family_conditions'>
                        Family Medical Conditions
                      </Label>
                      <Textarea
                    ...
                    <div className='flex items-center space-x-2'>
                      <input
                        ...
                        className='rounded border-gray-300'
                      />
                      <Label htmlFor='edit_heart_attack'>
                        Family History of Heart Attack
                      </Label>
                    </div>
                    {formData.heart_attack && (
                      <div className='space-y-2 ml-6'>
                        <Label htmlFor='edit_heart_attack_60'>
                          Under 60 years old?
                        </Label>
                        <Select
                          value={formData.heart_attack_60 || ''}
                    ...
                    <div className='flex items-center space-x-2'>
                      <input
                        ...
                        className='rounded border-gray-300'
                      />
                      <Label htmlFor='edit_cancer_family'>
                        Family History of Cancer
                      </Label>
                    </div>
                    {formData.cancer_family && (
                      <div className='space-y-2 ml-6'>
                        ...
                        <Input
                          ...
                          placeholder='Specify type of cancer'
                        />
                        <Label htmlFor='edit_age_of_cancer'>
                          Age at Diagnosis
                        </Label>
                        <Input
                    ...
                    <div className='space-y-2'>
                      <Label htmlFor='edit_family_members'>
                        Affected Family Members
                      </Label>
                      <Input
                    ...
                    <div className='space-y-2'>
                      <Label htmlFor='edit_other_family'>
                ...
                <TabsContent value='surgery' className='space-y-4'>
                  <div className='space-y-4'>
                    ...
                    {formData.surgery && (
                      <div className='space-y-2 ml-6'>
                        <Label htmlFor='edit_surgery_type'>
                          Type of Surgery
                        </Label>
                        <Input
                          ...
                          placeholder='Specify type of surgery'
                        />
                        <Label htmlFor='edit_surgery_year'>
                          Year of Surgery
                        </Label>
                        <Input
                ...
                <DialogDescription>
                  ...
                  <span className='font-medium'>
                    {deletingMedicalHistory
                      ? deletingMedicalHistory.employee_name ||
                        'Unknown Employee'
                      : ''}
                  </span>
      ...
      fallback={
        <div className='min-h-screen bg-background flex items-center justify-center'>
          <Card>
            <CardContent>
              <PageLoading
                text='Initializing Medical History'
                subtitle='Setting up medical history management system...'
              />
            </CardContent>
          </Card>
        </div>
