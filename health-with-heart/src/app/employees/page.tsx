...
import EmployeeTreatmentPlans from '@/components/EmployeeTreatmentPlans';
import EmployeeTBScreening from '@/components/EmployeeTBScreening';
...
export default function EmployeesPage() {
  ...
  const filterEmployees = useCallback((employees: Employee[], search: string, orgFilter?: string) => {
    let filtered = employees;
    
    // First filter by organization if specified
    if (orgFilter) {
      filtered = filtered.filter(employee => employee.organisation === orgFilter);
    }
  ...
  useEffect(() => {
    const filtered = filterEmployees(allEmployees, searchTerm, organizationFilter || undefined);
    setFilteredEmployees(filtered);
    
    // Reset to page 1 when filtering changes
    const page = searchTerm || organizationFilter ? 1 : parseInt(searchParams.get('page') || '1');
    const paginated = paginateEmployees(filtered, page, pagination.limit);
    setDisplayedEmployees(paginated);
  }, [allEmployees, searchTerm, organizationFilter, filterEmployees, paginateEmployees, pagination.limit, searchParams]);
            ...
            rightPanel={
              ...
              <Card className="glass-effect">
                <CardHeader className="pb-3">
                  ...
                  <div className="mt-4 pt-3 border-t border-border/50">
                    <EmployeeModuleProgress employeeId={selectedEmployee.id} employee={selectedEmployee} />
                  </div>
                </CardHeader>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="space-y-4">
                  ...
                  <Card className="glass-effect">
                    <CardContent className="p-4">
                      <EmployeeEmergencyResponses employeeId={selectedEmployee.id} />
                    </CardContent>
                  </Card>
