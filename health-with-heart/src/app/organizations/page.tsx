          ...
          <Card>
            <CardContent>
              <PageLoading
                ...
                subtitle='Fetching organization data from OHMS database...'
              />
            </CardContent>
          </Card>
        </div>
  ...
  return (
    ...
    <DashboardLayout>
      <div className='pl-8 pr-[5vw] sm:pl-12 sm:pr-[6vw] lg:pl-16 lg:pr-[8vw] xl:pl-24 xl:pr-[10vw] py-6 max-w-full overflow-hidden'>
        ...
        <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3'>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                {organizations.reduce(
                  (sum, org) => sum + parseInt(String(org.employee_count || 0)),
                  0
                )}
              </div>
              <p className='text-xs text-muted-foreground'>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                {organizations.reduce(
                  (sum, org) => sum + parseInt(String(org.manager_count || 0)),
                  0
                )}
              </div>
              <p className='text-xs text-muted-foreground'>
        ...
        {/* Search */}
        <Card className='glass-effect mt-6 mb-6'>
                  ...
                  <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between pt-4 border-t gap-2'>
                    ...
                    <div className='flex items-center space-x-1 flex-wrap'>
                      ...
                      >
                        ...
                        <span
                          className={`${selectedOrg && leftPanelWidth < 50 ? 'hidden' : 'hidden sm:inline'} ml-1`}
                        >
                          First
                        </span>
                      </Button>
                      ...
                      {Array.from(
                        {
                          length: Math.min(
                            selectedOrg && leftPanelWidth < 50 ? 3 : 5,
                        ...
                        (_, i) => {
                          const startPage = Math.max(
                            1,
                            pagination.page -
                              (selectedOrg && leftPanelWidth < 50 ? 1 : 2)
                          );
                      ...
                      >
                        <span
                          className={`${selectedOrg && leftPanelWidth < 50 ? 'hidden' : 'hidden sm:inline'} mr-1`}
                        >
                          Next
                        </span>
            ...
            {selectedOrg && (
              <div className='space-y-4 max-h-[80vh] overflow-y-auto scrollbar-thin'>
                ...
                <Card className='border-orange-200'>
                  ...
                  <CardContent className='space-y-4'>
                    {selectedOrg.logo && selectedOrg.logo.trim() !== '' ? (
      ...
      fallback={
        <div className='min-h-screen bg-background flex items-center justify-center'>
          <Card>
            <CardContent>
              <PageLoading
                text='Initializing Organizations'
                subtitle='Setting up organization management system...'
              />
            </CardContent>
          </Card>
        </div>
