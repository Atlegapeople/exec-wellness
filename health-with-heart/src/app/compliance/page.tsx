        ...
        <div className='pl-8 pr-[5vw] sm:pl-12 sm:pr-[6vw] lg:pl-16 lg:pr-[8vw] xl:pl-24 xl:pr-[10vw] py-6 max-w-full overflow-hidden'>
          ...
          <div className='flex items-center justify-between mb-6'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <Dialog
                open={isSendConsentDialogOpen}
                onOpenChange={setIsSendConsentDialogOpen}
              >
                      ...
                      <div className='space-y-2'>
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value='purpose_based'>
                              Purpose-based
                            </SelectItem>
                            <SelectItem value='employment_based'>
                              Employment-based
                            </SelectItem>
                          </SelectContent>
                        </Select>
