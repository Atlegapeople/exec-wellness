          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Comprehensive occupational health management system providing professional 
                medical services and health monitoring solutions.
              </p>
              <div className="flex items-center gap-2">
                <Heart className="h-4 w-4 text-red-500" />
                <span className="text-sm text-muted-foreground">Caring for workplace wellness</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Button variant="ghost" size="sm" className="justify-start p-0 h-auto text-sm" asChild>
                  <a href="/employees" className="flex items-center gap-2">
