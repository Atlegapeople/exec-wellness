      ...
      <div className="grid grid-cols-2 gap-4 text-sm">
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-900">{formatDate(treatmentPlan.generated_at)}</span>
          </div>
        </div>
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-900">{treatmentPlan.medical_staff.doctors.length}</span>
          </div>
          <div className="flex items-center gap-2">
            <User className="h-4 w-4 text-gray-400" />
            <span className="text-gray-600">Nurses:</span>
            <span className="text-gray-900">{treatmentPlan.medical_staff.nurses.length}</span>
          </div>
        </div>
      </div>
