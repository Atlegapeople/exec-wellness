...
export interface MenHealth {
  ...
  fertility_concerns: any;
  family_planning: any;
  genetic_risks: any;
  reproductive_header: string;
  cancer_screening: any;
  vaccination_status: any;
  dental_health: any;
  vision_health: any;
  hearing_health: any;
  preventive_header: string;
  workplace_stress: any;
  ergonomic_issues: any;
  chemical_exposure: any;
